...
class RacDacBulkMigrationTriggerAuditEventSpec extends AnyWordSpec with Matchers {
  ...
  "calling RacDacBulkMigrationTriggerAuditEvent" must {
    ...
    "returns correct event object" in {
      ...
      event.auditType mustBe "RetirementOrDeferredAnnuityContractBulkMigrationTriggerAudit"
