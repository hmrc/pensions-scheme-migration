...
class SchemeDataCacheControllerSpec extends WordSpec with MustMatchers with MockitoSugar with BeforeAndAfter {
  ...
  "SchemeDataCacheController" when {
    "calling get" must {
      "return OK with the data" in {
        ...
        val controller = app.injector.instanceOf[SchemeDataCacheController]
